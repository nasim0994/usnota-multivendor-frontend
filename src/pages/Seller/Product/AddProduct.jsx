...
export default function AddProduct() {
  ...
  const seller = loggedSeller?.data?._id;
  ...
  const handleAddProduct = async (e) => {
    ...
    if (res?.data?.success) {
      ...
      setVariants("");
      setDetails("");
      navigate("/seller/product/all-products");
    }
  };

  return (
    <section>
      {!loggedSeller?.data?.verify && (
        <p className="bg-cyan-100 p-3 rounded text-sm text-neutral mb-4">
          Your account unverify! please complete the verification to upload the
          product.{" "}
          <Link to="/seller/verification" className="text-primary underline">
            Verification Center
          </Link>
        </p>
      )}
          ...
          <div className="form_group">
            ...
            <div className="mt-6 flex justify-end">
              <button
                ...
                type="submit"
                disabled={
                  isLoading || (!loggedSeller?.data?.verify && "disabled")
                }
